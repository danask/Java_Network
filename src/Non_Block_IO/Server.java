...
public class Server
{
	...
	public class ServerThread extends Thread
	{
		...
		public void run()
		{
			...
			Selector selector = null;  // event listener for client request
...
Server :: accepted - client [java.nio.channels.SocketChannel[connected local=/127.0.0.1:9891 remote=/127.0.0.1:62147]]
Client :: started
From Client : test
From Client : aaaaaaaaaaaaaaaaaaaaaa
From Client : fin
From Client : exit
Client :: bye
 * 
